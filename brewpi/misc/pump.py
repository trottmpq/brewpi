...
def set_pump(kettle_id, onoff):
    requests.put(f'http://127.0.0.1:5000/devices/Kettle/{kettle_id}/pumpstate', json={'state': onoff})
...
if "__main__" == __name__:
    ...
    # Add the arguments
    my_parser.add_argument('kettle_id', type=int, help='id of kettle the pump is attached to in the db')
